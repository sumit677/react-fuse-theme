...
function UserMenu(props)
{
    ...
    const handleSetting = () => {
        setOpenSetting(true);
         console.log("openSetting p"+  openSetting);
       // settingref.current.sayHi();
        
    };

    console.log("out p"+  openSetting);
    return (
        <React.Fragment>
            ...
            <SettingsPanel openSettingValue={openSetting} changeSetting = {openSetting => setOpenSetting(openSetting)}/>
        </React.Fragment>
    );
}
