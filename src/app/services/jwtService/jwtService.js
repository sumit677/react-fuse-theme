        ...
        axios.interceptors.response.use(response => {
            ...
            return new Promise((resolve, reject) => {
                if ( err.response.status === 401 && err.config && !err.config.__isRetryRequest )
                {
                    ...
                    this.emit('onAutoLogout', 'Auto login functionality is currenty disabled');
    ...
    signIngIntoEDMWithEmailAndPassword = (email, password) => {
        return new Promise((resolve, reject) => {
            axios.get('http://192.168.5.119:8080/loginAuthenticate/authenticateCredentials1', {
               ...
               const user = JSON.parse('{"uuid":"XgbuVEXBU5gtSKdbQRP1Zbbby1i1","from":"custom-db","password":"admin","role":"admin","data":{"displayName":"Abbott Keitch","photoURL":"assets/images/avatars/Abbott.jpg","email":"admin","settings":{"layout":{"style":"layout1","config":{"scroll":"content","navbar":{"display":true,"folded":false,"position":"left"},"toolbar":{"display":true,"style":"fixed","position":"below"},"footer":{"display":false,"style":"fixed","position":"below"},"mode":"fullwidth"}},"customScrollbars":true},"shortcuts":["calendar","mail","contacts"]}}');
